        ...
        {data.map((item, index) => (
          <div
            ...
            className={`flex justify-start md:gap-10 ${
              index === 0 ? "pt-4 md:pt-0" : "pt-10 md:pt-40"
            }`}
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-2 md:top-0 self-start max-w-xs lg:max-w-sm md:w-full">
